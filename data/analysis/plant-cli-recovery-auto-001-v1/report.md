...
1/1 completed CLI calls covering 9 plants; 9 passed format checks; 0 failed (including execution failures). 0 valid null summaries.

Elapsed wall time: 46.2 seconds (0.77 minutes). Sum of CLI generation durations: 46.2 seconds.
...
| output_tokens | 1,776 |
| reasoning_output_tokens | 1,034 |
| uncached_input_tokens | 12,692 |
